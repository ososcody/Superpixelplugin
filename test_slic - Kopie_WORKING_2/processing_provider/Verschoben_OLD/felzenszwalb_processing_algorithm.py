...
class SuperpixelProcessingPluginFelzenszwalb(QgsProcessingAlgorithm):  # TODO: RENAME
    ...
    def displayName(self):
        return self.tr("Superpixelplugin - Felzenszwalb")
    ...
    def shortHelpString(self):
        return self.tr("The Felzenszwalb Superpixelalgorithm"
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        filepath_raster_a = str(provider.dataSourceUri())
        # ~~~~~
        ...
        # open the input raster with GDAL
        ...
        # Set manually to multichannel = True, because last axis means channels.
